...
class RagTool(BaseTool):
    ...
    def description(self) -> str:
        return ("Performs semantic search on documents to find and answer questions based on relevant content. "
                ...
                "Capabilities: Splits document into chunks, finds top 3 most relevant sections using semantic search, "
    ...
    def parameters(self) -> dict[str, Any]:
        return {
            ...
            "properties": {
                ...
                "request": {
                    "type": "string",
                    "description": "The search query to search for in the document"
                },
            },
    ...
    async def _execute(self, tool_call_params: ToolCallParams) -> str | Message:
        arguments = json.load(tool_call_params.tool_call.function.arguments)
        ...
        cached = self.document_cache.get(cache_document_key)
        if cached:
            index, chunks = cached
        else:
